...
URL<-"https://raw.githubusercontent.com/PrisonRodeo/GSERM-Oslo-2018-git/master/Data/SegalVotes.csv"
temp<-getURL(URL)
...
URL<-"https://raw.githubusercontent.com/PrisonRodeo/GSERM-Oslo-2018-git/master/Data/SFTF.csv"
temp<-getURL(URL)
