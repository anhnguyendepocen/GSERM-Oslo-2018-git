...
temp<-getURL("https://raw.githubusercontent.com/PrisonRodeo/GSERM-Oslo-2018-git/master/Data/HF1998.csv")
...
temp<-getURL("https://raw.githubusercontent.com/PrisonRodeo/GSERM-Oslo-2018-git/master/Data/AIDS-Africa-97-01.csv")
