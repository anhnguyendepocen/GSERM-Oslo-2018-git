...
CFURL<-"https://raw.githubusercontent.com/PrisonRodeo/GSERM-Oslo-2018-git/master/Data/ceasefiresTC.csv"
temp<-getURL(CFURL)
...
LNBURL<-"https://raw.githubusercontent.com/PrisonRodeo/GSERM-Oslo-2018-git/master/Data/LNB.csv"
temp<-getURL(LNBURL)
